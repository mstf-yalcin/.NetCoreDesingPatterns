...
builder.Services.AddSingleton<UserObserverSubject>(sp =>
{
    ...
    userObserverSubject.AddObserver(new UserObserverWriteToConsole(sp));
    userObserverSubject.AddObserver(new UserObserverCreateDiscount(sp));
    userObserverSubject.AddObserver(new UserObserverSendMail(sp));
